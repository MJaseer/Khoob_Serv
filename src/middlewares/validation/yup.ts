...
export class validationMiddleware {
    ...
    registerValidationMiddleware = async (req: Request, res: Response, next: NextFunction) => {
        try {
    ...
    loginValidationMiddleware = async (req: Request, res: Response, next: NextFunction) => {
        try {
