...
import { findOne } from "../../repositeries/common/find";
...
export const userRegister = async (req: Request, res: Response) => {
    try {
        ...
        const existingUser = await findOne('email', email, userSchema,'register');
...
export const userLogin = async (req: Request, res: Response) => {
    ...
    try {
        const existingUser = await findOne('email', email, userSchema);
